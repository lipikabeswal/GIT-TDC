...
bool ClientHandler::OnPreKeyEvent(CefRefPtr<CefBrowser> browser,
    ...
    //Custom handling for cut/copy/paste shortcuts
    if (event.modifiers == EVENTFLAG_COMMAND_DOWN && event.focus_on_editable_field) //CMD is pressed and focus is on a text field
    {
        //browser->GetMainFrame()->ExecuteJavaScript("console.log('You pressed the cmd!');", "", 0);
