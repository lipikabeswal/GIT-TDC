...
Class.make("LzAttributeDescriptor", ["attribute", void 0, "type", void 0, "value", void 0, "$lzsc$initialize", function ($0, $1, $2) {
    switch (arguments.length) {
        case 2:
            $2 = null;
...
Class.make("LzInitExpr", ["$lzsc$initialize", function ($0, $1, $2) {
    switch (arguments.length) {
        case 2:
            $2 = null;
...
Class.make("LzOnceExpr", ["methodName", void 0, "$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 3:
            $3 = null;
...
Class.make("LzConstraintExpr", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    switch (arguments.length) {
        case 3:
            $3 = null;
...
Class.make("LzStyleConstraintExpr", ["property", void 0, "fallback", void 0, "warn", void 0, "$lzsc$initialize", function ($0, $1, $2, $3, $4) {
    switch (arguments.length) {
        case 3:
            $3 = void 0;
        case 4:
    ...
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this, $0, $1, null);
    this.property = $2;
    this.type = $1;
    this.fallback = $3;
    this.warn = $4
}], LzConstraintExpr);
Class.make("LzAlwaysExpr", ["dependenciesName", void 0, "$lzsc$initialize", function ($0, $1, $2, $3, $4) {
    switch (arguments.length) {
        case 4:
            $4 = null;

    };
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this, $0, $1, $2, $4);
    this.dependenciesName = $3
}], LzConstraintExpr);
...
Class.make("LzStyleIdent", ["sourceValueID", void 0, "$lzsc$initialize", function ($0) {
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this);
...
Class.make("LzStyleAttrBinder", ["target", void 0, "dest", void 0, "source", void 0, "$lzsc$initialize", function ($0, $1, $2) {
    ...
    if ($4 !== $3 || !$1.inited) {
        {
            if (!$1.__LZdeleted) {
                var $lzsc$czke6v = "$lzc$set_" + $2;
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa($1[$lzsc$czke6v]) : $1[$lzsc$czke6v] instanceof Function) {
                    $1[$lzsc$czke6v]($4)
                } else {
                    $1[$2] = $4;
                    var $lzsc$9qaokn = $1["on" + $2];
                    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$9qaokn) : $lzsc$9qaokn instanceof LzEvent) {
...
Class.make("$lz$class_TextPresentationType", ["accept", function ($0, $1, $2) {
    var $3 = $lz$class_TextPresentationType.xmlEscapes;
    var $4 = "";
...
Class.make("$lz$class_CSSDeclarationPresentationType", ["PropRE", new RegExp("^\\s*(\\S*)\\s*:\\s*(\\S*)\\s*$"), "HyphenRE", new RegExp("-(\\w)", "g"), "CapitalRE", new RegExp("[:upper:]", "g"), "accept", function ($0, $1, $2) {
    var $3 = $0.split(",");
    var $4 = {};
...
Class.make("LzNode", ["__LZisnew", false, "__LZdeferredcarr", null, "classChildren", null, "animators", null, "__animatedAttributes", void 0, "_instanceAttrs", null, "_instanceChildren", null, "__LzValueExprs", null, "__LZhasConstraint", function ($0) {
    ...
    this.__LZisnew = !$3;
    var $b = this["constructor"]["children"];
    if (Array["$lzsc$isa"] ? Array.$lzsc$isa($b) : $b instanceof Array) {
        $2 = LzNode.mergeChildren($2, $b)
    };
    if ($6["datapath"] != null) {
        delete $6["$datapath"]
    };
    var $c = this.__LzValueExprs = {};
    for (var $7 in $6) {
        var $9 = $6[$7];
        if (LzValueExpr["$lzsc$isa"] ? LzValueExpr.$lzsc$isa($9) : $9 instanceof LzValueExpr) {
            $c[$7] = $9;
            delete $6[$7]
        }
    };
    ...
    this.__LZdeferDelegates = false;
    var $e = this.__LZdelegatesQueue;
    if ($e) {
        LzDelegate.__LZdrainDelegatesQueue($e);
        this.__LZdelegatesQueue = null
    };
    ...
    var $0 = this.__LZCSSDependencies;
    if ($0) {
    ...
    var $1 = LzCSSStyle.getPropertyCache(this);
    this.__LZRuleCache = null;
    this.__LZPropertyCache = null;
    var $2 = LzCSSStyle.getPropertyCache(this);
    var $3 = this.__LZCSSProp;
    var $4 = this.__LZCSSType;
    var $5 = this.__LZCSSFallback;
    for (var $6 in $3) {
        var $7 = $3[$6];
        if ($1[$7] != $2[$7]) {
    ...
    this.__LZCSSProp[$0] = $1;
    if (!this.__LZCSSType) {
        this.__LZCSSType = {}
    };
    this.__LZCSSType[$0] = $2;
    if (!this.__LZCSSFallback) {
        this.__LZCSSFallback = {}
    };
    this.__LZCSSFallback[$0] = $3;
    var $6 = $5[$1];
    ...
    if (LzStyleExpr["$lzsc$isa"] ? LzStyleExpr.$lzsc$isa($6) : $6 instanceof LzStyleExpr) {
        if (LzStyleAttr["$lzsc$isa"] ? LzStyleAttr.$lzsc$isa($6) : $6 instanceof LzStyleAttr) {
            ...
            this.__LZconstraintdelegates.push(new LzDelegate($9, "bind", this, "on" + $8));
            $9.bind()
        ...
        if (this[$0] !== $6) {
            {
                if (!this.__LZdeleted) {
                    var $lzsc$qjgu4o = "$lzc$set_" + $0;
                    if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$qjgu4o]) : this[$lzsc$qjgu4o] instanceof Function) {
                        this[$lzsc$qjgu4o]($6)
                    } else {
                        this[$0] = $6;
                        var $lzsc$6lei59 = this["on" + $0];
                        if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$6lei59) : $lzsc$6lei59 instanceof LzEvent) {
        ...
        if (this[$0] !== $3) {
            {
                if (!this.__LZdeleted) {
                    var $lzsc$gj5aem = "$lzc$set_" + $0;
                    if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$gj5aem]) : this[$lzsc$gj5aem] instanceof Function) {
                        this[$lzsc$gj5aem]($3)
                    } else {
                        this[$0] = $3;
                        var $lzsc$c7sr2z = this["on" + $0];
                        if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$c7sr2z) : $lzsc$c7sr2z instanceof LzEvent) {
    ...
    if ("$delegates" in $0) {
        var $c = $0.$delegates;
        var $d = this.__LZconstraintdelegates;
        var $e;
        for (var $f = 0, $g = $c.length; $f < $g; $f += 3) {
            if ($c[$f + 2]) {
                if ($e == null) {
                    $e = []
                };
    ...
    for (var $3 = 0; $3 < $2; $3 += 3) {
        ...
        if ($5 == null) $5 = this;
        var $6 = $0[$3 + 1];
        $1.push(new LzDelegate(this, $6, $5, $0[$3]))
    }
    ...
    if ($0 instanceof LzAlwaysExpr) {
        ...
        if (!(Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$5]) : this[$5] instanceof Function)) {

        } else {
            try {
                $3 = this[$5]();
                for (var $6 = 0, $7 = $3.length; $6 < $7; $6 += 2) {
                    var $8 = $3[$6];
                    if ($8 != null && !(LzEventable["$lzsc$isa"] ? LzEventable.$lzsc$isa($8) : $8 instanceof LzEventable)) {
                        $3[$6] = null
                    }
                }
            } catch ($9) {}
    ...
    if ($2 == 0) {
        var $5 = $3 ? this[$0] + $1 : $1; {
            if (!this.__LZdeleted) {
                var $lzsc$f8tzeh = "$lzc$set_" + $0;
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$f8tzeh]) : this[$lzsc$f8tzeh] instanceof Function) {
                    this[$lzsc$f8tzeh]($5)
                } else {
                    this[$0] = $5;
                    var $lzsc$844jmi = this["on" + $0];
                    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$844jmi) : $lzsc$844jmi instanceof LzEvent) {
    ...
    if ($4 != null) {
        if (typeof $3 == "string" && $4[$3] === $0) {
            ...
            if (!$6) {
                ...
                var $7 = $4.subnodes;
                var $8, $9 = 0;
                for (var $a = 0, $b = $7.length; $a < $b; $a++) {
                    var $c = $7[$a];
                    if ($6 == $c.constructor.tagname) {
                        $9++;
                        if ($8) break
                    };
                    if ($0 === $c) {
    ...
    if (this[$0] !== $2) {
        {
            if (!this.__LZdeleted) {
                var $lzsc$jsm90r = "$lzc$set_" + $0;
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$jsm90r]) : this[$lzsc$jsm90r] instanceof Function) {
                    this[$lzsc$jsm90r]($2)
                } else {
                    this[$0] = $2;
                    var $lzsc$d18dsr = this["on" + $0];
                    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$d18dsr) : $lzsc$d18dsr instanceof LzEvent) {
...
Class.make("LzKernelUtils", null, null, ["CSSDimension", function ($0, $1) {
    ...
    var $9 = Math.min($3, $4) * 0.5;
    $5 = LzKernelUtils.range($5 || 0, $9, 0);
    if ($8 == null) {
        $8 = $7 = $6 = $5
    } else {
        $8 = LzKernelUtils.range($8 || 0, $9, 0);
        $7 = LzKernelUtils.range($7 || 0, $9, 0);
        $6 = LzKernelUtils.range($6 || 0, $9, 0)
    };
    var $a = $0["curveTo"] ? "curveTo" : "quadraticCurveTo";
    $0.moveTo($1, $2 + $5);
    $0.lineTo($1, $2 + $4 - $8);
    if ($8 != 0) {
        $0[$a]($1, $2 + $4, $1 + $8, $2 + $4)
...
var LzMouseKernel = {
    ...
    __mouseEvent: function ($0) {
        ...
        var $4 = window["LzInputTextSprite"] && LzInputTextSprite.prototype;
        if ($4 && $4.__lastshown != null) {
    ...
    __handleContextMenu: function ($0) {
        ...
        if ($1) {
            ...
            var $5 = $0.target || $0.srcElement;
            if ($5 && $5.owner && $3 !== true) {
                LzMouseKernel.__contextmenumouse2 = $4;
    ...
    __findContextMenu: function ($0) {
        ...
        if (document.elementFromPoint) {
            ...
            if (window.pageXOffset) {
                var $4 = $0.pageX - window.top.pageXOffset;
                var $5 = $0.pageY - window.top.pageYOffset
            } else {
                var $4 = $0.clientX;
                var $5 = $0.clientY
            };
...
var LzSprite = function ($0, $1) {
    ...
    if ($1) {
        ...
        if ($2.fix_clickable) {
            ...
            LzSprite.__setClickable(true, $6)
        };
        if ($2["css_hide_canvas_during_init"]) {
            ...
            if ($2["fix_clickable"]) this.__LZclickcontainerdiv.style[$b] = $c;
            if ($2["fix_contextmenu"]) this.__LZcontextcontainerdiv.style[$b] = $c
        };
...
LzSprite.__updateQuirks = function () {
    ...
    if (window["lz"] && lz.embed && lz.embed.browser) {
        ...
        if ($4.isIE) {
            ...
            $0["forcemeasurescrollheight"] = true;
...
LzSprite.__clickDispatcher = function ($0) {
    ...
    if (LzSprite.prototype.capabilities.touchevents) {
        if ($3 === "ontouchstart") {
            ...
            var $4 = lz.BrowserUtils.getcallbackfunc($2, "__mouseEvent", ["onmouseout"]);
            setTimeout($4, 0);
            var $4 = lz.BrowserUtils.getcallbackfunc($2, "__mouseEvent", ["onclick"]);
            setTimeout($4, 0)
        } else {
            return true
        }
    ...
    if ($2.isroot === true) {
        ...
        LzMouseKernel.__sendEvent($3, null);
        return false
    };
...
LzSprite.prototype.getContext = function () {
    ...
    lz.embed.__setAttr($0, "width", this.width);
    lz.embed.__setAttr($0, "height", this.height);
    if (this.cornerradius != null) {
        this.__applyCornerRadius($0)
    };
...
LzSprite.prototype.__createContainerDivs = function ($0) {
    ...
    var $2 = true;
    if (this.quirks.dont_clip_clickdivs && $0 === "click") {
        $2 = false
    };
    if (this[$1]) {
        return this[$1]
    ...
    for (var $4 = $3.length - 1; $4 >= 0; $4--) {
        ...
        this.__copystyles($5.__LZdiv, $6, $2);
        if ($5._id && !$6.id) {
            $6.id = $0 + $5._id
        };
        $6.owner = $5;
...
LzSprite.prototype.__copystyles = function ($0, $1, $2) {
    ...
    var $6 = $3.__csscache.__LZdivdisplay || "";
    if ($6) {
        $1.style.display = $6
    };
    $1.style.zIndex = $3._z || $0.style.zIndex;
    if ($2 && $3._clip) {
...
LzSprite.prototype.__updateTransform = function ($0) {
    ...
    this._transform = $1;
    var $2 = LzSprite.__styleNames.transform;
...
LzSprite.prototype.__getShadowCSS = function ($0, $1, $2, $3) {
    ...
    if (this.quirks.use_filter_for_dropshadow) {
        if ($1 == 0) {
            this.xoffset = this.yoffset = -$3;
            this.applyCSS("left", this.x + this.xoffset);
            this.applyCSS("top", this.y + this.yoffset);
            if ($3 > 0) {
                var $4 = LzColorUtils.inttohex($0);
                return "progid:DXImageTransform.Microsoft.Glow(Color='" + $4 + "',Strength=" + $3 + ")"
            }
        } else {
            $2 += 90;
            var $4 = LzColorUtils.inttohex($0);
            return "progid:DXImageTransform.Microsoft.Shadow(Color='" + $4 + "',Direction=" + $2 + ",Strength=" + $1 + ")"
        }
    } else {
        var $5 = $2 * Math.PI / 180;
        var $6 = this.CSSDimension(Math.cos($5) * $1);
        var $7 = this.CSSDimension(Math.sin($5) * $1);
        var $8 = LzColorUtils.torgb($0);
        return $8 + " " + $6 + " " + $7 + " " + this.CSSDimension($3)
    }
};
...
LzSprite.prototype.__applyCornerRadius = function ($0) {
    ...
    if (this.quirks.explicitly_set_border_radius) {
        var $2 = this.cornerradius.split(" ");
        $0.style[$1.borderTopLeftRadius] = $2[0];
        $0.style[$1.borderTopRightRadius] = $2[1];
        $0.style[$1.borderBottomRightRadius] = $2[2];
        $0.style[$1.borderBottomLeftRadius] = $2[3]
    } else {
...
LzInputTextSprite.prototype.__textEvent = function ($0) {
    ...
    var $3 = $1.quirks;
    if ($2 === "onmousedown" || $2 === "onmouseup" || $2 === "onmouseout" || $2 === "onmousemove") {
        if ($3.autoscroll_textarea) {
            if ($2 === "onmousedown") {
                ...
                if ($1.dragging) {
                    var $4 = $1.__LzInputDiv;
                    var $5 = $0.pageY - $4.offsetTop;
                    if ($5 <= 3) {
    ...
    if ($2 === "onfocus") {
        ...
        if ($1.restrict || $1.multiline && $6.maxlength && $6.maxlength < Infinity) {
            var $7 = $0.keyCode;
            var $8 = $3.text_event_charcode ? $0.charCode : $0.keyCode;
                ...
                if ($3.keypress_function_keys) {
                    ...
                    if ($f) {
                        if ($1.restrict) {
                            ...
                            var $d = $1.__LzInputDiv.value.length,
                                $e = $6.maxlength;
...
LzFontManager.__createContainerDiv = function () {
    var $0 = document.createElement("div");
    lz.embed.__setAttr($0, "id", "lzTextSizeCache");
...
LzFontManager.__createMeasureDiv = function ($0, $1) {
    ...
    if (LzSprite.prototype.quirks["text_measurement_use_insertadjacenthtml"]) {
        ...
        lz.embed.__setAttr($5, "class", $0);
        lz.embed.__setAttr($5, "style", $1);
...
Class.make("LzView", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    if (this[$0]) {
        if (!this.__LZdeleted) {
            var $lzsc$i08t1p = "$lzc$set_" + $0;
            if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$i08t1p]) : this[$lzsc$i08t1p] instanceof Function) {
                this[$lzsc$i08t1p]($1)
            } else {
                this[$0] = $1;
                var $lzsc$73vhde = this["on" + $0];
                if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$73vhde) : $lzsc$73vhde instanceof LzEvent) {
    ...
    if ($0 == "x" || $0 == "y") {
        $2.update($0); {
            var $lzsc$ofxkzc = ($3 - $2[$0 + "offset"]) / $2[$0 + "scale"];
            if (!this.__LZdeleted) {
                var $lzsc$glf2q9 = "$lzc$set_" + $0;
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$glf2q9]) : this[$lzsc$glf2q9] instanceof Function) {
                    this[$lzsc$glf2q9]($lzsc$ofxkzc)
                } else {
                    this[$0] = $lzsc$ofxkzc;
                    var $lzsc$5c7s53 = this["on" + $0];
                    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$5c7s53) : $lzsc$5c7s53 instanceof LzEvent) {
        ...
        $2.update($4);
        var $5 = $4 + "scale"; {
            var $lzsc$kserwz = $3 * $1[$5] / $2[$5] / this[$5];
            if (!this.__LZdeleted) {
                var $lzsc$2wbmrs = "$lzc$set_" + $0;
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this[$lzsc$2wbmrs]) : this[$lzsc$2wbmrs] instanceof Function) {
                    this[$lzsc$2wbmrs]($lzsc$kserwz)
                } else {
                    this[$0] = $lzsc$kserwz;
                    var $lzsc$kpvu11 = this["on" + $0];
                    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$kpvu11) : $lzsc$kpvu11 instanceof LzEvent) {
        ...
        if ($0) {
            {
                if (!this.__LZdeleted) {
                    if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this["$lzc$set_context"]) : this["$lzc$set_context"] instanceof Function) {
                        ...
                        this["context"] = $0;
                        var $lzsc$vaeqza = this["oncontext"];
                        if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$vaeqza) : $lzsc$vaeqza instanceof LzEvent) {
...
Class.make("LzText", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    if ($4.length > 0) {
        var $6 = this.searchParentAttrs($4);
        for (var $5 in $6) {
            var $7 = $6[$5];
            this[$5] = $3[$5] = $7[$5];
    ...
    this.tsprite.__initTextProperties($3);
    this.yscroll = 0;
    this.xscroll = 0;
...
Class.make("LzCanvas", ["updatePercentCreatedEnabled", true, "_lzinitialsubviews", [], "totalnodes", void 0, "framerate", 30, "onframerate", LzDeclaredEvent, "creatednodes", void 0, "__LZproxied", void 0, "embedfonts", void 0, "lpsbuild", void 0, "lpsbuilddate", void 0, "appbuilddate", void 0, "runtime", void 0, "allowfullscreen", void 0, "fullscreen", void 0, "onfullscreen", LzDeclaredEvent, "__LZmouseupDel", void 0, "__LZmousedownDel", void 0, "__LZmousemoveDel", void 0, "__LZDefaultCanvasMenu", void 0, "httpdataprovider", null, "defaultdataprovider", null, "$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    if ($1["fontsize"] != null) {
        this.fontsize = LzCanvas.attributes.fontsize.fallback = $1.fontsize;
        delete $1.fontsize
    };
    if ($1["fontstyle"] != null) {
        this.fontstyle = LzCanvas.attributes.fontstyle.fallback = $1.fontstyle;
        delete $1.fontstyle
    };
    if ($1["font"] != null) {
        this.font = LzCanvas.attributes.font.fallback = $1.font;
        delete $1.font
    };
    if ($1["bgcolor"] != null) {
        LzCanvas.attributes.bgcolor.fallback = $1.bgcolor;
        delete $1.bgcolor
    };
    if ($1["width"] != null) {
        LzCanvas.attributes.width.fallback = $1.width;
        delete $1.width
    };
    if ($1["height"] != null) {
        LzCanvas.attributes.height.fallback = $1.height;
        delete $1.height
    };
    (arguments.callee["$superclass"] && arguments.callee.$superclass.prototype["$lzsc$initialize"] || this.nextMethod(arguments.callee, "$lzsc$initialize")).call(this, $0, $1, $2, $3);
...
Class.make("LzAnimator", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    if (this.from != null) {
        {
            var $lzsc$y6rzll = Number(this.from);
            if (!$0.__LZdeleted) {
                var $lzsc$l2wpj0 = "$lzc$set_" + $1;
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa($0[$lzsc$l2wpj0]) : $0[$lzsc$l2wpj0] instanceof Function) {
                    $0[$lzsc$l2wpj0]($lzsc$y6rzll)
                } else {
                    $0[$1] = $lzsc$y6rzll;
                    var $lzsc$ckzsfh = $0["on" + $1];
                    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$ckzsfh) : $lzsc$ckzsfh instanceof LzEvent) {
    ...
    if ($3 != null) {
        $2[$1] += Number($3 - $2[$1]); {
            var $lzsc$ulzn5 = Number($3);
            if (!$0.__LZdeleted) {
                var $lzsc$av6itx = "$lzc$set_" + $1;
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa($0[$lzsc$av6itx]) : $0[$lzsc$av6itx] instanceof Function) {
                    $0[$lzsc$av6itx]($lzsc$ulzn5)
                } else {
                    $0[$1] = $lzsc$ulzn5;
                    var $lzsc$1sfi1h = $0["on" + $1];
                    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$1sfi1h) : $lzsc$1sfi1h instanceof LzEvent) {
    ...
    if (this.updateCounter(-1) == 0) {
        ...
        delete $2[$1]; {
            if (!$0.__LZdeleted) {
                var $lzsc$ic3yjm = "$lzc$set_" + $1;
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa($0[$lzsc$ic3yjm]) : $0[$lzsc$ic3yjm] instanceof Function) {
                    $0[$lzsc$ic3yjm]($3)
                } else {
                    $0[$1] = $3;
                    var $lzsc$pumjm7 = $0["on" + $1];
                    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$pumjm7) : $lzsc$pumjm7 instanceof LzEvent) {
    ...
    if (this.doBegin) {
        ...
        if (!this.paused) {
            ...
            var $5 = this.attribute; {
                var $lzsc$vq3tua = $4[$5] + ($3 - this.currentValue);
                if (!$4.__LZdeleted) {
                    var $lzsc$788o40 = "$lzc$set_" + $5;
                    if (Function["$lzsc$isa"] ? Function.$lzsc$isa($4[$lzsc$788o40]) : $4[$lzsc$788o40] instanceof Function) {
                        $4[$lzsc$788o40]($lzsc$vq3tua)
                    } else {
                        $4[$5] = $lzsc$vq3tua;
                        var $lzsc$6d2jaz = $4["on" + $5];
                        if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$6d2jaz) : $lzsc$6d2jaz instanceof LzEvent) {
...
Class.make("LzState", ["heldArgs", void 0, "releasedconstraints", void 0, "appliedChildren", void 0, "applyOnInit", false, "__LZpool", null, "__LZstateconstraintdelegates", void 0, "$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    return $0
}], LzNode, ["tagname", "state", "attributes", new LzInheritedHash(LzNode.attributes), "events", {
    onremove: true,
    onapply: true,
    onapplied: true
}]);
...
}], LzNode, ["tagname", "datapointer", "attributes", {
...
Class.make("LzReplicationManager", ["asyncnew", true, "initialnodes", void 0, "clonePool", void 0, "cloneClass", void 0, "cloneParent", void 0, "cloneAttrs", void 0, "cloneChildren", void 0, "hasdata", void 0, "orderpath", void 0, "comparator", void 0, "__LZxpathconstr", null, "__LZxpathdepend", null, "visible", true, "__LZpreventXPathUpdate", false, "nodes", void 0, "clones", void 0, "__LZdataoffset", 0, "onnodes", LzDeclaredEvent, "onclones", LzDeclaredEvent, "onvisible", LzDeclaredEvent, "$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    if (LzAlwaysExpr["$lzsc$isa"] ? LzAlwaysExpr.$lzsc$isa($8) : $8 instanceof LzAlwaysExpr) {
        ...
        if (LzAlwaysExpr["$lzsc$isa"] ? LzAlwaysExpr.$lzsc$isa($a) : $a instanceof LzAlwaysExpr) {
            ...
            this.__LZpreventXPathUpdate = true;
            $b.applyConstraintExpr(new LzAlwaysExpr("xpath", "string", "__LZxpathconstr", "__LZxpathdepend"));
            this.__LZpreventXPathUpdate = false;
            if (this.pooling) {
...
Class.make("LzDataAttrBind", ["$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    if ($3) {
        ...
        if ($2 || $5[$6] !== $7 || !$5.inited || this.parsedPath.operator == "attributes") {
            {
                if (!$5.__LZdeleted) {
                    var $lzsc$plduwl = "$lzc$set_" + $6;
                    if (Function["$lzsc$isa"] ? Function.$lzsc$isa($5[$lzsc$plduwl]) : $5[$lzsc$plduwl] instanceof Function) {
                        $5[$lzsc$plduwl]($7)
                    } else {
                        $5[$6] = $7;
                        var $lzsc$7vxc4h = $5["on" + $6];
                        if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$7vxc4h) : $lzsc$7vxc4h instanceof LzEvent) {
...
Class.make("LzLazyReplicationManager", ["sizeAxis", void 0, "cloneimmediateparent", void 0, "updateDel", void 0, "__LZoldnodelen", void 0, "viewsize", 0, "totalsize", 0, "mask", null, "$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    this.totalsize = this.viewsize + $1.spacing; {
        var $lzsc$q75esc = this.axis;
        var $lzsc$h3c7mt = this.totalsize;
        if (!$6.__LZdeleted) {
            var $lzsc$1ndxlp = "$lzc$set_" + $lzsc$q75esc;
            if (Function["$lzsc$isa"] ? Function.$lzsc$isa($6[$lzsc$1ndxlp]) : $6[$lzsc$1ndxlp] instanceof Function) {
                $6[$lzsc$1ndxlp]($lzsc$h3c7mt)
            } else {
                $6[$lzsc$q75esc] = $lzsc$h3c7mt;
                var $lzsc$q6kz6u = $6["on" + $lzsc$q75esc];
                if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$q6kz6u) : $lzsc$q6kz6u instanceof LzEvent) {
    ...
    if ($3) {
        ...
        if (this.__LZoldnodelen != $7) {
            {
                var $lzsc$egq15n = $7 * $6 - this.spacing;
                if (!$2.__LZdeleted) {
                    var $lzsc$iyhbl7 = "$lzc$set_" + $5;
                    if (Function["$lzsc$isa"] ? Function.$lzsc$isa($2[$lzsc$iyhbl7]) : $2[$lzsc$iyhbl7] instanceof Function) {
                        $2[$lzsc$iyhbl7]($lzsc$egq15n)
                    } else {
                        $2[$5] = $lzsc$egq15n;
                        var $lzsc$43sya2 = $2["on" + $5];
                        if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$43sya2) : $lzsc$43sya2 instanceof LzEvent) {
    ...
    for (var $f = 0; $f < $d; $f++) {
        ...
        if ($g) {
            this.clones[$f] = $g; {
                var $lzsc$n81tp1 = ($f + $8) * $6;
                if (!$g.__LZdeleted) {
                    var $lzsc$an74m = "$lzc$set_" + $4;
                    if (Function["$lzsc$isa"] ? Function.$lzsc$isa($g[$lzsc$an74m]) : $g[$lzsc$an74m] instanceof Function) {
                        $g[$lzsc$an74m]($lzsc$n81tp1)
                    } else {
                        $g[$4] = $lzsc$n81tp1;
                        var $lzsc$7bom50 = $g["on" + $4];
                        if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$7bom50) : $lzsc$7bom50 instanceof LzEvent) {
...
Class.make("LzResizeReplicationManager", ["datasizevar", void 0, "__LZresizeupdating", void 0, "$lzsc$initialize", function ($0, $1, $2, $3) {
    ...
    for (var $e = 0; $e < this.clones.length; $e++) {
        ...
        this.clones[$e] = $m; {
            var $lzsc$wjsqfm = this.axis;
            if (!$m.__LZdeleted) {
                var $lzsc$87xud3 = "$lzc$set_" + $lzsc$wjsqfm;
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa($m[$lzsc$87xud3]) : $m[$lzsc$87xud3] instanceof Function) {
                    $m[$lzsc$87xud3]($n)
                } else {
                    $m[$lzsc$wjsqfm] = $n;
                    var $lzsc$gvh2vu = $m["on" + $lzsc$wjsqfm];
                    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$gvh2vu) : $lzsc$gvh2vu instanceof LzEvent) {
        ...
        if ($m[this.sizeAxis] != $h) {
            {
                var $lzsc$7111hi = this.sizeAxis;
                if (!$m.__LZdeleted) {
                    var $lzsc$7i5kih = "$lzc$set_" + $lzsc$7111hi;
                    if (Function["$lzsc$isa"] ? Function.$lzsc$isa($m[$lzsc$7i5kih]) : $m[$lzsc$7i5kih] instanceof Function) {
                        $m[$lzsc$7i5kih]($h)
                    } else {
                        $m[$lzsc$7111hi] = $h;
                        var $lzsc$b07c1m = $m["on" + $lzsc$7111hi];
                        if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$b07c1m) : $lzsc$b07c1m instanceof LzEvent) {
    ...
    this.__LZdataoffset = $5; {
        var $lzsc$bmyf1x = this.cloneimmediateparent;
        var $lzsc$z2li6w = this.sizeAxis;
        if (!$lzsc$bmyf1x.__LZdeleted) {
            var $lzsc$yh34dy = "$lzc$set_" + $lzsc$z2li6w;
            if (Function["$lzsc$isa"] ? Function.$lzsc$isa($lzsc$bmyf1x[$lzsc$yh34dy]) : $lzsc$bmyf1x[$lzsc$yh34dy] instanceof Function) {
                $lzsc$bmyf1x[$lzsc$yh34dy]($9)
            } else {
                $lzsc$bmyf1x[$lzsc$z2li6w] = $9;
                var $lzsc$by31u0 = $lzsc$bmyf1x["on" + $lzsc$z2li6w];
                if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$by31u0) : $lzsc$by31u0 instanceof LzEvent) {
...
Class.make("LzColorUtils", null, null, ["__cache", {
    ...
    var $1 = $0.substring($0.indexOf("(") + 1, $0.lastIndexOf(")")).split(",");
    var $2 = LzColorUtils.rgbatoint($1[0], $1[1], $1[2], $1[3]);
    if (!isNaN($2)) {
        return $2
    };
    return 0
    ...
    var $3 = ($0 >> 16 & 255) / 255,
        $4 = ($0 >> 8 & 255) / 255,
        $5 = ($0 & 255) / 255;
    var $6 = Math.min($3, Math.min($4, $5)),
        $7 = Math.max($3, Math.max($4, $5));
    var $8 = $7;
    var $9 = $7 - $6;
    if ($9 == 0) {
        $1[$2] = {
    ...
    var $5 = 0;
    if ($4.length > 6) {
        $5 = parseInt($4.slice(6), 16) / 25500;
        $4 = $4.slice(0, 6)
    };
    var $1 = parseInt($4, 16);
    switch ($4.length) {
        case 3:
            $4 = (($1 & 3840) << 8 | ($1 & 240) << 4 | $1 & 15) * 17 + $5;
            break;
        case 6:
            $4 = $1 + $5;
            break;
    ...
    var $5 = "#" + LzColorUtils.dectohex($2, $1);
    var $6 = LzColorUtils.findalpha($0);
    if ($6 != null) {
        var $7 = $6.toString(16);
        if ($7.length == 1) {
            $7 = "0" + $7
...
Class.make("LzHistoryService", ["$lzsc$initialize", function () {
    ...
    for (var $4 in $3) {
        var $5 = $3[$4]; {
            var $lzsc$7sxekq = global[$5.c];
            var $lzsc$prthp8 = $5.n;
            var $lzsc$4m5q00 = $5.v;
            if (!$lzsc$7sxekq.__LZdeleted) {
                var $lzsc$i6vsfh = "$lzc$set_" + $lzsc$prthp8;
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa($lzsc$7sxekq[$lzsc$i6vsfh]) : $lzsc$7sxekq[$lzsc$i6vsfh] instanceof Function) {
                    $lzsc$7sxekq[$lzsc$i6vsfh]($lzsc$4m5q00)
                } else {
                    $lzsc$7sxekq[$lzsc$prthp8] = $lzsc$4m5q00;
                    var $lzsc$yixlrk = $lzsc$7sxekq["on" + $lzsc$prthp8];
                    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$yixlrk) : $lzsc$yixlrk instanceof LzEvent) {
...
}, "receiveEvent", function ($0, $1) {
    {
        if (!canvas.__LZdeleted) {
            var $lzsc$dipco5 = "$lzc$set_" + $0;
            if (Function["$lzsc$isa"] ? Function.$lzsc$isa(canvas[$lzsc$dipco5]) : canvas[$lzsc$dipco5] instanceof Function) {
                canvas[$lzsc$dipco5]($1)
            } else {
                canvas[$0] = $1;
                var $lzsc$ssz62b = canvas["on" + $0];
                if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$ssz62b) : $lzsc$ssz62b instanceof LzEvent) {
...
Class.make("LzCSSStyleRule", ["parsed", null, "specificity", 0, "properties", void 0, "$lzsc$initialize", function ($0, $1) {
    this.parsed = $0;
    if ($0["length"]) {
        var $2 = 0;
        for (var $3 = 0, $4 = $0.length; $3 < $4; $3++) {
            $2 += $0[$3].s
        };
        this.specificity = $2
    } else {
    ...
    pname = function ($0) {
        ...
        var $4 = $0["v"];
        var $5 = $0["m"] || "=";
        return ($1 ? $1 : "") + ($2 ? "#" + $2 : "") + ($3 ? ($3 == "styleclass" ? "." + $4 : "[" + $3 + ($4 ? $5 + $4 : "") + "]") : "") + (("&" in $0) ? pname($0["&"]) : "")
    };
    var $0 = this.parsed;
    if ($0["length"]) {
        var $1 = "";
...
Class.make("LzCSSStyleClass", ["$lzsc$initialize", function () {
    ...
    var $4 = $0["__LZRuleCache"] || this.getRulesCache($0);
    if ($4.length == 0) {
    ...
    var $7 = this._tagRules;
    for (var $8 in $7) {
        var $9 = lz[$8];
        if ($9 && ($9["$lzsc$isa"] ? $9.$lzsc$isa($0) : $0 instanceof $9)) {
            $2 = $2.concat($7[$8])
        }
    };
    $2.concat(this._rules);
    var $a = new LzCSSStyleDependencies();
    var $b = false;
    var $c = Infinity;
    for (var $d = 0, $e = $2.length; $d < $e; $d++) {
        var $f = $2[$d];
        if (!$b) {
            var $g = $f.specificity;
            if (!$g || $g >= $c) {
        ...
        var $l = $h["i"];
        var $m = false;
        if ((!$j || $k && ($k["$lzsc$isa"] ? $k.$lzsc$isa($0) : $0 instanceof $k)) && (!$l || $0["id"] == $l)) {
            if (!$i) {
                if (!$h["a"] && !$h["&"]) {
                    $m = true
                } else {
    ...
    if (this._rulenum != this._lastSort) {
        ...
        for (var $1 in this._idRules) {
            var $3 = this._idRules[$1];
            $3.sort(this.__compareSpecificity);
            $0($3)
        };
        for (var $1 in this._tagRules) {
            var $4 = this._tagRules[$1];
            $4.sort(this.__compareSpecificity);
            $0($4)
        };
...
Class.make("$lzc$class_lzcontextmenuseparator", ["$ii6lnt1", function ($0) {
...
(function ($0) {
    with($0) with($0.prototype) {
        {
            LzNode.mergeAttributes({
                $delegates: ["oninit", "$ii6lnt1", null, "ondestroy", "$ii6lnt2", null],
                height: 10
            }, $lzc$class_lzcontextmenuseparator.attributes)
        }
    }
})($lzc$class_lzcontextmenuseparator);
Class.make("$lzc$class_lzcontextmenutext", ["$ii6lnt3", function ($0) {
...
(function ($0) {
    with($0) with($0.prototype) {
        {
            LzNode.mergeAttributes({
                $delegates: ["onmouseover", "$ii6lnt3", null, "onmouseout", "$ii6lnt4", null, "onmousedown", "$ii6lnt5", null],
                clickable: true,
                fgcolor: LzColorUtils.convertColor("0x0"),
                fontsize: 11,
                fontstyle: "plain"
...
(function ($0) {
    with($0) with($0.prototype) {
        {
            LzNode.mergeAttributes({
                fgcolor: LzColorUtils.convertColor("0xcccccc"),
                fontsize: 11,
                fontstyle: "plain"
...
Class.make("$lzc$class_ii6lntc", ["$ii6lnt7", function ($0) {
    ...
    if ($1 !== this["width"] || !this.inited) {
        {
            if (!this.__LZdeleted) {
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this["$lzc$set_width"]) : this["$lzc$set_width"] instanceof Function) {
                    ...
                    this["width"] = $1;
                    var $lzsc$7qf0mw = this["onwidth"];
                    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$7qf0mw) : $lzsc$7qf0mw instanceof LzEvent) {
    ...
    if ($1 !== this["height"] || !this.inited) {
        {
            if (!this.__LZdeleted) {
                if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this["$lzc$set_height"]) : this["$lzc$set_height"] instanceof Function) {
                    ...
                    this["height"] = $1;
                    var $lzsc$b1i1om = this["onheight"];
                    if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$b1i1om) : $lzsc$b1i1om instanceof LzEvent) {
...
Class.make("$lzc$class_lzcontextmenu", ["inset", void 0, "__drawnitems", void 0, "__overnow", void 0, "$ii6lnt6", function ($0) {
    ...
    this.bringToFront(); {
        ...
        if (!this.__LZdeleted) {
            if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this["$lzc$set_x"]) : this["$lzc$set_x"] instanceof Function) {
                ...
                this["x"] = $lzsc$clf60f;
                var $lzsc$kqamy1 = this["onx"];
                if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$kqamy1) : $lzsc$kqamy1 instanceof LzEvent) {
        ...
        if (!this.__LZdeleted) {
            if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this["$lzc$set_y"]) : this["$lzc$set_y"] instanceof Function) {
                ...
                this["y"] = $lzsc$bmhny;
                var $lzsc$l9m4ib = this["ony"];
                if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$l9m4ib) : $lzsc$l9m4ib instanceof LzEvent) {
        ...
        if (!this.__LZdeleted) {
            if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this["$lzc$set_visible"]) : this["$lzc$set_visible"] instanceof Function) {
                ...
                this["visible"] = true;
                var $lzsc$621n5b = this["onvisible"];
                if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$621n5b) : $lzsc$621n5b instanceof LzEvent) {
    ...
    if ($0) $0.__hide(); {
        if (!this.__LZdeleted) {
            if (Function["$lzsc$isa"] ? Function.$lzsc$isa(this["$lzc$set_visible"]) : this["$lzc$set_visible"] instanceof Function) {
                ...
                this["visible"] = false;
                var $lzsc$mvanqs = this["onvisible"];
                if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$mvanqs) : $lzsc$mvanqs instanceof LzEvent) {
            ...
            var $8 = new $7(this, {
                ...
                if (!$8.__LZdeleted) {
                    if (Function["$lzsc$isa"] ? Function.$lzsc$isa($8["$lzc$set_y"]) : $8["$lzc$set_y"] instanceof Function) {
                        ...
                        $8["y"] = $5;
                        var $lzsc$l97d1g = $8["ony"];
                        if (LzEvent["$lzsc$isa"] ? LzEvent.$lzsc$isa($lzsc$l97d1g) : $lzsc$l97d1g instanceof LzEvent) {
    ...
    attrs: {
        $classrootdepth: 1,
        $delegates: ["oninit", "$ii6lntb", null, "onwidth", "__doredraw", null, "onheight", "__doredraw", null, "oncontext", "__doredraw", null, "onvisible", "__doredraw", null],
        height: new LzAlwaysExpr("height", "size", "$ii6lnt9", "$ii6lnta", null),
        name: "background",
        width: new LzAlwaysExpr("width", "size", "$ii6lnt7", "$ii6lnt8", null)
    },
    "class": $lzc$class_ii6lntc
}, {
    attrs: {
        $classrootdepth: 1,
        name: "container",
