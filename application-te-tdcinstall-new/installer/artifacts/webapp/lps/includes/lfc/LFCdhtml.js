...
$1.onmouseout()
}}}};var LzMouseKernel={__lastMouseDown:null,__lastMouseOver:null,__lastMouseOut:null,__lastMouseContext:null,__x:0,__y:0,owner:null,__showncontextmenu:null,__mouseEvent:function($0){
...
return
};var $0=LzSprite.__defaultStyles.hyphenate($0);if($0=="grabbing_cursor"){
if(lz.embed.browser.browser=="Mozilla"){
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor","move")
}else{
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor","url(ctbmodules/resources/iknow_cursors/dragger_press.png),auto");LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor","url(ctbmodules/resources/iknow_cursors/dragger_press.png),auto");LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor","url(ctbmodules/resources/iknow_cursors/dragger_press.png),auto");LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor","url(ctbmodules/resources/iknow_cursors/dragger_press.png),auto")
}}else if($0=="cangrab_cursor"){
if(lz.embed.browser.browser=="Mozilla"){
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor","move")
}else{
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor","url(ctbmodules/resources/iknow_cursors/dragger_over.png),auto");LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor","url(ctbmodules/resources/iknow_cursors/dragger_over.png),auto");LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor","url(ctbmodules/resources/iknow_cursors/dragger_over.png),auto");LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor","url(ctbmodules/resources/iknow_cursors/dragger_over.png),auto")
}}else if($0=="eliminate_cursor"){
if(lz.embed.browser.browser=="Mozilla"){
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor","move")
}else{
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor","url(ctbmodules/resources/iknow_cursors/cursor_eliminate.svg),auto");LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor","url(ctbmodules/resources/iknow_cursors/cursor_eliminate.svg),auto");LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor","url(ctbmodules/resources/iknow_cursors/cursor_eliminate.svg),auto");LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor","url(ctbmodules/resources/iknow_cursors/cursor_eliminate.svg),auto")
}}else if($0=="highlight_cursor"){
if(lz.embed.browser.browser=="Mozilla"){
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor","move")
}else{
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor","url(ctbmodules/resources/iknow_cursors/cursor_highliter.svg),auto");LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor","url(ctbmodules/resources/iknow_cursors/cursor_highliter.svg),auto");LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor","url(ctbmodules/resources/iknow_cursors/cursor_highliter.svg),auto");LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor","url(ctbmodules/resources/iknow_cursors/cursor_highliter.svg),auto")
}}else if($0=="erase_cursor"){
if(lz.embed.browser.browser=="Mozilla"){
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor","move");LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor","move")
}else{
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor","url(ctbmodules/resources/iknow_cursors/cursor_eraser.svg),auto");LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor","url(ctbmodules/resources/iknow_cursors/cursor_eraser.svg),auto");LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor","url(ctbmodules/resources/iknow_cursors/cursor_eraser.svg),auto");LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor","url(ctbmodules/resources/iknow_cursors/cursor_eraser.svg),auto")
}}else{
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor",$0);LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor",$0);LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor",$0);LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor",$0)
...
$0["fix_ie9_textwidth"]=true;$1["cornerradius"]=true;$1["rotation"]=true;$2.transform="MsTransform";$2.transformOrigin="MsTransformOrigin"
};if($4.version<=8){
$0["ie_opacity"]=true
...
LzMouseKernel.__lastMouseContext.__globalmouseup($0)
}else if($8&&$8!==$2){
$8.__globalmouseup($0)
...
catch($0){}};LzSprite.prototype.__LZimg=null;LzSprite.prototype.playing=false;LzSprite.prototype.frame=1;LzSprite.prototype.frames=null;LzSprite.prototype.is_html=false;LzSprite.blankimage="lps/includes/blank.gif";LzSprite.prototype.resourceurl=null;LzSprite.prototype.resource=null;LzSprite.prototype.source=null;LzSprite.prototype.stretches=null;LzSprite.prototype.resourceWidth=null;LzSprite.prototype.resourceHeight=null;LzSprite.prototype.cursor=null;LzSprite.prototype.loading=false;LzSprite.prototype.setResource=function($0){
...
$5.style.lineHeight="inherit";var $6=lz.BrowserUtils.getcallbackfunc(this,"__updatewhitespace",[]);setTimeout($6,0)
};if(this.scrolling){
...
};var $4=$2.scrollLeft;var $5=$2.scrollTop;this.__discardElement($2);this.__LZdiv.appendChild($3);$3.style.margin="0px";if(!$0)$3.style.height="auto";$3.scrollLeft=$4;$3.scrollTop=$5;this.setScrollEvents(this.owner.scrollevents);this.__setTextEvents(true);this.setText(this.text,true)
...
var view=this.owner.owner;var that=this;setTimeout(function(){
...
};$1.__hide();if(lz.embed.browser.isChrome||lz.embed.browser.isSafari){
...
};if($5.autoscroll_textarea&&$4==="onkeydown"&&$6.selectionStart===$n.length){
...
var $2=new (this.cloneClass)(this.cloneParent,this.cloneAttrs,this.cloneChildren,$0==null?this.asyncnew:!$0)
...
}}})(LzTimerService);lz.TimerService=LzTimerService;lz.Timer=LzTimerService.LzTimer;lz.ClassAttributeTypes["lzcontextmenuseparator"]=LzNode.mergeAttributeTypes(lz.ClassAttributeTypes["view"],{});Class.make("$lzc$class_lzcontextmenuseparator",["$egfbmg1",function($0){
...
with($0)with($0.prototype){
{
LzNode.mergeAttributes({$CSSDescriptor:{},$attributeDescriptor:{types:lz.ClassAttributeTypes["lzcontextmenuseparator"]},$delegates:["oninit","$egfbmg1",null,"ondestroy","$egfbmg2",null],height:10},$lzc$class_lzcontextmenuseparator.attributes)
}}})($lzc$class_lzcontextmenuseparator);lz.ClassAttributeTypes["lzcontextmenutext"]=LzNode.mergeAttributeTypes(lz.ClassAttributeTypes["text"],{});Class.make("$lzc$class_lzcontextmenutext",["$egfbmg6",function($0){
...
with($0)with($0.prototype){
{
LzNode.mergeAttributes({$CSSDescriptor:{},$attributeDescriptor:{types:lz.ClassAttributeTypes["lzcontextmenutext"]},$delegates:["onmouseover","$egfbmg6",null,"onmouseout","$egfbmg7",null,"onmousedown","$egfbmg8",null],clickable:true,fgcolor:0,fontsize:11,fontstyle:"plain"},$lzc$class_lzcontextmenutext.attributes)
...
}}})($lzc$class_lzcontextmenudisabled);lz.ClassAttributeTypes["$lzc$class__egfbmgf"]=LzNode.mergeAttributeTypes(lz.ClassAttributeTypes["view"],{});Class.make("$lzc$class__egfbmgf",["$egfbmga",function($0){
...
with($0)with($0.prototype){
{
LzNode.mergeAttributes({$CSSDescriptor:{},$attributeDescriptor:{types:lz.ClassAttributeTypes["$lzc$class__egfbmgf"]}},$lzc$class__egfbmgf.attributes)
}}})($lzc$class__egfbmgf);lz.ClassAttributeTypes["lzcontextmenu"]=LzNode.mergeAttributeTypes(lz.ClassAttributeTypes["view"],{_lockdrawing:"boolean",defaultplacement:"string",inset:"number"});Class.make("$lzc$class_lzcontextmenu",["inset",void 0,"__drawnitems",void 0,"__overnow",void 0,"_lockdrawing",void 0,"$egfbmg9",function($0){
...
}],LzView,["tagname","lzcontextmenu","children",[{attrs:{$classrootdepth:1,$delegates:["oninit","$egfbmge",null,"onwidth","__doredraw",null,"onheight","__doredraw",null,"oncontext","__doredraw",null,"onvisible","__doredraw",null],height:new LzAlwaysExpr("$egfbmgc","$egfbmgd",null),name:"background",width:new LzAlwaysExpr("$egfbmga","$egfbmgb",null)},"class":$lzc$class__egfbmgf},{attrs:{$CSSDescriptor:{},$attributeDescriptor:{types:lz.ClassAttributeTypes["container"]},$classrootdepth:1,name:"container",x:3,y:3},"class":LzView},{attrs:"container","class":$lzc$class_userClassPlacement}],"__LZCSSTagSelectors",["lzcontextmenu","view","node","$lfc$LzEventable","Instance"],"attributes",new LzInheritedHash(LzView.attributes)]);(function($0){
with($0)with($0.prototype){
{
LzNode.mergeAttributes({$CSSDescriptor:{},$attributeDescriptor:{types:lz.ClassAttributeTypes["lzcontextmenu"]},$delegates:["oninit","$egfbmg9",null],__drawnitems:{},__overnow:null,_lockdrawing:false,clickable:true,inset:5,options:{ignorelayout:true},showhandcursor:false,visible:false},$lzc$class_lzcontextmenu.attributes)
