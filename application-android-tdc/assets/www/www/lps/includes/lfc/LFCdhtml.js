...
if(LzSprite.quirks.no_cursor_colresize){
return
};if(LzMouseKernel.__amLocked)return;LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor","default");LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor","default");if(LzSprite.quirks.fix_clickable){
...
if($0.button==2)return;var $8=LzMouseKernel.__lastMouseDown;if($8&&$8!==$2){
$8.__globalmouseup($0)
...
var $c=$0.keyCode;var $d=$5.text_event_charcode?$0.charCode:$0.keyCode;var $e=!($0.ctrlKey||$0.altKey)&&($d>=32||$c===13);if($e){
var $f=false;if($c!=13&&$1.restrict){
$f=0>String.fromCharCode($d).search($1.restrict)
};if(!$f){
var $g=$1.getSelectionSize();if($g<=0){
if($5.text_ie_carriagereturn){
var $h=$1.__LzInputDiv.value.replace($1.____crregexp,"\n")
}else{
var $h=$1.__LzInputDiv.value
};var $i=$h.length,$j=$b.maxlength;if($i>=$j){
$f=true
}}};if($f){
$0.returnValue=false;if($0.preventDefault){
$0.preventDefault()
...
var $k=false;if($0.ctrlKey&&!$0.altKey&&!$0.shiftKey){
var $l=String.fromCharCode($d);$k=$l==="v"||$l==="V"
...
var $i=$1.__LzInputDiv.value.length,$j=$b.maxlength;if($i<$j||$1.getSelectionSize()>0){
$1.__pasteHandler()
}else{
$0.returnValue=false;if($0.preventDefault){
$0.preventDefault()
...
var $6=$1.__LzInputDiv;var $m=$6.value;if($m!=$1.text){
$1.text=$m;if($1.multiline){
if($1.quirks["forcemeasurescrollheight"]){
$6.style.height=0;var $n=$6.scrollTop;$6.scrollTop=0;if($1._h!=0){
$6.style.height=$1._h
};if($n!=0){
$6.scrollTop=$n
...
var $0=lz.Keys.isKeyDown("shift");this.downKeysHash={};this.downKeysArray=[];LzKeyboardKernel.__allKeysUp();if($0){
