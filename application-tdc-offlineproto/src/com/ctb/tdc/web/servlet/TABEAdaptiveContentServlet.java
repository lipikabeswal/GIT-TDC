 ...
 * @author John_Wang
 */
public class TABEAdaptiveContentServlet extends HttpServlet {
	 ...
	 */
	public TABEAdaptiveContentServlet() {
		super();
	}
	...
	private void getItem(HttpServletRequest request,
		...
		try {
			...
			if(itemxml == null) {
				...
				itemxml = itemxml.replaceFirst("<item_model", "<item_model allow_revisit=\"false\"");
