...
var $0=this._setCanvasAttributeQ.shift();this.setCanvasAttribute($0[0],$0[1],$0[2])
}},_ready:function($0){
...
setTimeout("lz.embed._broadcastMethod('_sendAllKeysUp')",200);this.callMethod("lz.Focus.applicationFocus()")
},_gotBlur:function(){
...
}})();lz.embed.attachEventHandler(window,"focus",lz.embed,"_gotFocus");lz.embed.attachEventHandler(window,"blur",lz.embed,"_gotBlur");lz.embed.__iframemanager_callbacks=[];lz.embed.iframemanager={create:function($0,$1,$2,$3,$4,$5){
